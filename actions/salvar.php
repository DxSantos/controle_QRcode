...
// Verificar se o QR Code existe e está ativo na nova tabela midiaQR
...
// Inserir registro na tabela 'midias'
$stmt = $pdo->prepare("
INSERT INTO midias (midiaQR_id, tipo, arquivo) 
VALUES (?, ?, ?)
");
$stmt->execute([$midiaQR_id, $tipo, $arquivo]);
